...
const (
	...
	kubernetesCSEHelpersScriptUbuntu  = "linux/cloud-init/artifacts/cse_helpers_ubuntu.sh"
	kubernetesCSEHelpersScriptMariner = "linux/cloud-init/artifacts/cse_helpers_mariner.sh"
	kubernetesCSEInstall              = "linux/cloud-init/artifacts/cse_install.sh"
	kubernetesCSEInstallUbuntu        = "linux/cloud-init/artifacts/cse_install_ubuntu.sh"
	kubernetesCSEInstallMariner       = "linux/cloud-init/artifacts/cse_install_mariner.sh"
